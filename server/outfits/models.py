...
class Outfit(models.Model):
    ...
    user = models.ForeignKey(User, db_column="user_id", on_delete=models.CASCADE, related_name='outfit')
    name = models.CharField(max_length=255)
    image = models.ImageField()
    clothes = models.ManyToManyField(Clothes, blank=True, related_name='in_outfit')
    ...
    likes = models.ManyToManyField(User, blank=True, related_name='liked_outfit')
